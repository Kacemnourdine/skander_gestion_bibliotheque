...
class AuthorController extends AbstractController
{
    ...
    public function index(AuthorRepository $authorRepository, PaginatorInterface $paginatorInterface,Request $request ): Response
    {
        $data = $authorRepository->findAll();
        $authors = $paginatorInterface->paginate(
            $data,
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('succes','l auther a ete ajoute');
